...
const Login = () => {
  const { signInUser, signInWithGoogle, createUser } = useAuth();
  ...
  const handleDemoLogin = async () => {
    const demoEmail = "musfi@gmail.com";
    const demoPassword = "!@1235()";
    ...
    try {
      ...
      try {
        await createUser(demoEmail, demoPassword);
    ...
    <div className="min-h-screen flex bg-white dark:bg-[#0a0f1a] font-sans">
      ...
      >
        ...
        <div className="relative z-10 p-12 text-white">
          ...
          <p className="text-blue-100 text-xl max-w-md">
            Log in to manage bookings and explore premium rides.
          </p>
        </div>
      </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <motion.div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 py-4 rounded-2xl bg-gray-50"
                />
              </div>
            </div>
          ...
          <div className="my-8 text-center text-gray-400 text-xs">OR</div>

          <button
            onClick={handleGoogleLogin}
            className="w-full flex justify-center gap-3 border py-4 rounded-2xl"
          >
